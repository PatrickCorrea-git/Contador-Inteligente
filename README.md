...
Este projeto está licenciado sob a [MIT License](LICENSE).# Contador-Inteligente
Um componente React, número que muda, botões que disparam eventos e um valor que não causa render, só conta renderizações
